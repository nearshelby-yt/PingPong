...
\033[1;33m
+--------------------------------+
| \033[1;36mBem vindo ao Ping Pong         \033[1;33m|
\033[1;33m|                                \033[1;33m|
| \033[1;36mCriador -> Near Shelby         \033[1;33m|
\033[1;33m|                                \033[1;33m|
| \033[1;36mBiblioteca utilizada -> Pygame \033[1;33m|
\033[1;33m+--------------------------------+
\033[1;33m| \033[1;36mJogador 1 = ^ Baixo            \033[1;33m|
\033[1;33m| \033[1;36mJogador 2 = W S                \033[1;33m|
\033[1;33m+--------------------------------+
""")
...
def redraw():
    ...
    text = font.render('PING PONG', False, pingPong)
    ...
    p1_score = font.render(str(paddle1.points), False, colorBall)
    ...
    p2_score = font.render(str(paddle2.points), False, colorBall)
